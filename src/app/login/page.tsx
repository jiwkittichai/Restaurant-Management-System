        ...
        <form onSubmit={submit} className="mt-7 space-y-4">
          <label className="block">
            ...
            <div className="mt-1 flex items-center border border-gray-200 rounded-xl px-3 focus-within:border-blue-400">
              ...
              <input autoFocus required value={username} onChange={e=>setUsername(e.target.value)} className="w-full px-3 py-3 outline-none" />
            </div>
          </label>
          <label className="block">
            ...
            <div className="mt-1 flex items-center border border-gray-200 rounded-xl px-3 focus-within:border-blue-400">
              ...
              <input required type="password" value={password} onChange={e=>setPassword(e.target.value)} className="w-full px-3 py-3 outline-none" />
            </div>
          </label>
